 ...
 * @link https://claudflare.serverless-gems.dev/function/open-graph-image-generator-v2/
 */
...
export const onRequestGet = async ({request}) => {
  ...
  let title = decodeURIComponent(urlParams.get("title") || `Hello World!`);
  let subtitle = decodeURIComponent(urlParams.get("subtitle") || `serverless-gems.com`);
